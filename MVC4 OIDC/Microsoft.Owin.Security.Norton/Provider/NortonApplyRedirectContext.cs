...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Norton middleware
    /// </summary>
    public class NortonApplyRedirectContext : BaseContext<NortonAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Norton middleware options</param>
        ...
        public NortonApplyRedirectContext(IOwinContext context, NortonAuthenticationOptions options,
